...
class IdeaSeeder extends Seeder
{
    ...
    public function run()
    {
        $idea = \App\Idea::create([
            ...
            'name' => 'Hello World',
            'slug' => 'hello-world',
            'description_sort' => 'It is a given that applications must provide users with the functionalitynecessary to accomplish some task or goal.',
            'description_required' => "It is a given that applications must provide users with the functionality
...
'description_additional' => "### Constraints
...
'description' => "It is a given that applications must provide users with the functionality
necessary to accomplish some task or goal. The effectiveness of app functionality
is the first determinate of how users perceive the apps they use. However, it
is not the only thing that influences user satisfaction.
