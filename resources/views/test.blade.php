...
<body>
    <div id="app" class="flex flex-col h-screen justify-between">
        <header>
            <nav class="flex items-center justify-between flex-wrap bg-white p-4 py-3 lg:px-40 shadow-sm border border-gray-200">
        ...
        <main class="mb-auto p-4 py-3 md:py-5 lg:px-40">
            ...
            <div class="flex content-center flex-wrap bg-gray-200 mt-4">
